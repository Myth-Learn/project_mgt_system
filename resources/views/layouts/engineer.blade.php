	        ...
	        <li class="blue">
	         ...
	         <li class="red with-sub">
	            <span href="project.html">
	             ...
	             <ul>
	                <li><a href="documentation.html"><span class="lbl">Download Projects</span></a></li>
	            </ul>
	        </li>
			...
			<div class="box-typical box-typical-full-height">
				<div class="add-customers-screen tbl">
					<div class="add-customers-screen-in">
						...
						<p class="lead color-blue-grey-lighter">Your Account is under review please wait till we verify your details.<br/> We will send you a notification email once your account is approved.</p>
					</div>
				</div>
			</div><!--.box-typical-->
		</div><!--.container-fluid-->
